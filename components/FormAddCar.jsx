        ...
        <>
          <div className="form-car">
            ...
            <div className="btn-save-cancel">
                <Link href="/listCars"><button className="btn btn-cancel my-2 my-sm-0" type="button">Cancel</button></Link>
                <Link href="/listCars"><button className="btn btn-save my-2 my-sm-0" type="button">Save</button></Link>
            </div>
        </>
    )
}
